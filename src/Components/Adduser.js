...
import { UserCreateRequest, getUserByIdRequest, updateUserRequest } from '../Redux/action';
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            try {
                ...
                if (id) {
                    const response = await dispatch(updateUserRequest(userData));
